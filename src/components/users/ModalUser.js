...
const ModalUser = ({ open, onClose, id = null, onSuccess }) => {
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      if (id) {
        ...
        await useApi.users.updateUser(id, formData);
      } else {
        // Create new user
        await useApi.users.createUser(formData);
      }
      onSuccess && onSuccess();
      // Optionally, you can add a callback here to refresh the user list or show a success message
    } catch (error) {
